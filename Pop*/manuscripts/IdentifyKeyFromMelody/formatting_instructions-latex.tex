...
\pdfinfo{
/Title (Comparative analysis of key inference methods from melody in symbolic music)
...
%Methods
We assess the accuracy of several traditional and machine learning approaches to the key inference problem on a dataset of 500 melodies in MIDI format. We evaluate the impact of including note duration and note repetition as learning features.
%Results
We find machine learning approaches outperform traditional key inference methods. The highest accuracy (76.47\%) was achieved using a 2nd-order Markov model.
%Conclusions
Including note repetition as a learning feature tended to improve accuracy whereas including note duration tended toward lower accuracies. Our findings suggest that the key of a melodic passage depends more heavily on the sequence of the notes rather than their frequency or distribution. 
\end{abstract}
...
\begin{itemize}
\item You must use the latest AAAI Press \LaTeX{} style file.
