...
public abstract class LyricalEngineer {
	...
	protected abstract LyricSegment generateSegmentLyrics(Inspiration inspiration, Substructure segmentSubstructures, SegmentType segmentKey);

	private Map<SegmentType, LyricSegment[]> initLyricSegments(Map<SegmentType, Substructure[]> substructure) {
